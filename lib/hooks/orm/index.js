module.exports = function(sails) {
	...
	return {
		...
		startORM: function(cb, stack) {
			...
			util.each(modelDefs, function eachModelDef (modelDef, modelID) {
				sails.log.verbose(
			...
			waterline.initialize({
				...
				adapters: _buildAdHocAdapterSet(modelDefs)
			}, cb);
		},
	...
	function _buildAdHocAdapterSet (modelDefinitions) {
		...
		util.each(modelDefinitions, function eachModelDef (modelDef) {
			...
			modelDef.adapter = util.cloneDeep(modelDef.connections);
