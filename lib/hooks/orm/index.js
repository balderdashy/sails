...
var conditionalModels = require('./conditional-models');
    ...
    initialize: function(cb) {
      ...
      async.auto({
        ...
        instantiatedCollections: ['_doubleCheckMigration', function (next, async_data) {
          ...
          async_data.normalizedModelDefs = conditionalModels(async_data.normalizedModelDefs);
          // var time = Date.now() - Date.parse(_initial);
          // console.log(async_data.normalizedModelDefs);
          // console.log("Prebuild process finish in " + time + "ms");
