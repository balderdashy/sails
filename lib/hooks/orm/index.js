	...
	return {
		...
		initialize: function(cb) {
			...
			async.auto({
				...
				_modelDefs: ['_loadModules', function normalizeModelDefs (cb) {
				...
				instantiatedCollections: ['_modelDefs', this.startORM],
		...
		startORM: function(cb) {
			...
			// TODO: global not necessary here-- replace w/ async stack reference
			var modelDefs = sails.models;
