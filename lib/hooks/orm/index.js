			...
			if (sails.config.adapters) {
				...
				if (sails.config.adapters['default']) {
					...
					sails.after('lifted', function () {
						...
						logUpgradeNotice(NOTICES.upgrade['config.models.connection'], [], sails.log.info);
					});
				...
				sails.after('lifted', function () {
					...
					logUpgradeNotice(NOTICES.upgrade['config.connections'], [], sails.log.info);
				});
				_.each(sails.config.adapters, function (legacyAdapterConfig, connectionName) {
					...
					sails.after('lifted', function () {
						...
						logUpgradeNotice(NOTICES.upgrade['config.connections.*.adapter'], [connectionName], sails.log.info);
					});
