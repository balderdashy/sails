...
var howto_initializeORM = require('./initialize-orm');
...
module.exports = function(sails) {
  ...
  var initializeORM = howto_initializeORM(sails);
  ...
  var hook = {
    ...
    initialize: function(cb) {
      ...
      async.auto({
        ...
        // `sails.config.models.*`
        normalizedModelDefs: ['_loadModules',
          function normalizeModelDefs(next) {
        ...
        // sails.models.
        instantiatedCollections: ['modelDefs', function (next, async_data) {
          initializeORM(async_data.normalizedModelDefs, next);
        }]
