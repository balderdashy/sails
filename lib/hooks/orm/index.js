module.exports = function(sails) {
	...
	return {
		...
		initialize: function(cb) {
			...
			loadModules(function(err) {
				...
				////////////////////////////////////////////////////////////////////////
				// Normalize model definitions and merge in defaults
				// TODO: pull this out into another function
				////////////////////////////////////////////////////////////////////////
				util.each(sails.models, function eachModel (modelDef, mid) {

					// Default each model definition to the keys in `config.models`
					...
					// Go through each connection-- if it is a string, dereference it
					// (i.e. reference to a named connection)
					util.map( modelDef.connections, function eachConnection (connection) {
						...
						throw new Error(
							'Invalid connection/adapter reference (' + connection + ') ' +
							'in model (' + modelDef.identity +')'
						);
					});
	...
	function loadCollection(modelId, cb) {
