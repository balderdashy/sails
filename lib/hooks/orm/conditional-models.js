// TODO: Make that works with lowerCase all time!
 ...
 */
 ...
 var _mergeSchemas = function(collection){
  ...
  _.forEach(modelsWithConditionalSchema, function(model){
    var conditionalSchema = collection[model].conditionals;
