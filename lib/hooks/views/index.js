	...
	function _addResViewMethod(req, res, next) {
		...
		res.view = function (specifiedPath, locals, cb_view) {
			...
			if (layout) {
				...
				console.log('Layout: ', absPathToLayout);
			}
			...
			// Render the view
			console.log('Specified view: ', specifiedPath);
			console.log('Serving view at rel path: ', relPathToView);
			console.log('View root: ', sails.config.paths.views);
