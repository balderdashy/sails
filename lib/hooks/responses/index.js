		...
		configure: function () {
			...
			if ( typeof sails.config[500] === 'function' ) {
				sails.after('lifted', function () {
					logDeprecationNotice('sails.config[500]', LINKS.docs.migrationGuide.responses, sails.log.debug);
			...
			if ( typeof sails.config[404] === 'function' ) {
				sails.after('lifted', function () {
					logDeprecationNotice('sails.config[404]', LINKS.docs.migrationGuide.responses, sails.log.debug);
