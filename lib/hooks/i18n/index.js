module.exports = function(sails) {
  ...
  return {
    ...
    expressMiddleware: function (req, res, next) {
      ...
      // TODO: remove this
      // (we can't use it- it would do a synchronous file read on every request)
      // (see https://github.com/jeresig/i18n-node-2/blob/b99fd69469d0f014c1a2015800aa206d8ed23998/i18n.js#L60)
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
