...
module.exports = function(sails) {
  ...
  var Session = {
    ...
    initialize: function(cb) {
      ...
      if (util.isObject(sessionConfig) && !util.isObject(sessionConfig.store)) {
        ...
        if (sessionConfig.adapter) {
          ...
          if (sessionConfig.adapter === 'memory') {
            ...
            sessionConfig.store = new MemoryStore(saveSession(cb));
          }
          ...
          // or catch and return error:
            ...
            try {
              ...
              sessionConfig.store = new CustomStore(sessionConfig, saveSession(cb));
            } catch (e) {
      ...
      // Save session and do cb in cases where session is disabled
