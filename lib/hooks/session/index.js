          ...
          // or catch and return error:
            ...
            var COULD_NOT_REQUIRE_CONNECT_ADAPTER_ERR = function (adapter, packagejson, e) {
              ...
              if (adapter === 'connect-redis') {
                ...
                installRecommendation +='\n(Note: Make sure the version of the Connect adapter you install is compatible with Express 4/Sails v0.12)';
              }
              installRecommendation += '\n';
            ...
            try {
              ...
              var session = require('express-session');
              var CustomStore = require(pathToAdapterDependency)(session);
              sessionConfig.store = new CustomStore(sessionConfig);
              sessionConfig.secret = app.config.session.secret;
