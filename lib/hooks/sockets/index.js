	...
	return {
		...
		initialize: function(cb) {
			...
			if (sails.config.hooks.http) {
				...
				sails.log.error('Socket server cannot be started without HTTP server because the feature has not been implemented yet!');
				sails.log.warn('For now, please reenable the `http` hook.');
				process.exit(1);
