			...
			before: {
				...
				'get /firehose': function(req, res) {
					...
					if (process.env.NODE_ENV !== 'development') {
						sails.log.warn("Subscribing to firehose is only recommended for apps in development.  Use model pubsub methods in your production app.\n(in new apps, the `example.js` file in `assets/js/example.js`subscribes to the `firehose` by default.  To prevent this, just remove the relevant line from the front-end javascript.)");
					}
