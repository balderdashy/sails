module.exports = function(sails) {
	...
	return {
		defaults: {
			...
			// Whether shadow routes are automatically generated for controller actions:
			...
			////////////////////////////////////////////////////////////////////////////
			// TODO: move the following options into the blueprint definitions themselves:
		...
		initialize: function (cb) {
			...
			// Expose `blueprints` object on `sails`.
			sails.blueprints = {};

			// TODO: load blueprints using moduleloader
...
// 					sails.log.silly('Binding RESTful controller blueprints for',controllerId);
...
// 					sails.log.silly('Binding shortcut controller blueprints for',controllerId);
...
// 		// All conditions satisfied; binding blueprint category...
