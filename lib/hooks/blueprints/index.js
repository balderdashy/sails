...
module.exports = function(sails) {	
	...
	function bindShadowRoutes () {
		...
		_.each(sails.middleware.controllers, function eachController (controller, controllerId) {
			...
			// console.log('sails.middleware.controllers.'+controllerId+'= ',sails.middleware.controllers[controllerId]);
			...
			// console.log('bind shadow routes for ' + controllerId + ' actions ::', actions);
