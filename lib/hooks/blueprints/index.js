    ...
    defaults: {
      ...
      blueprints: {
        ...
        parseRequest: function(req) {
          return req._sails.hooks.blueprints.parseRequest(req);
        }
      ...
      if ( config.rest ) {
        ...
        _.each(sails.models, function(Model, identity) {
          ...
          sails.router.bind(
            ...
            null,
            { model: identity, associations: _.cloneDeep(Model.associations), populate: sails.config.blueprints.populate, autoWatch: sails.config.blueprints.autoWatch, _middlewareType: 'BLUEPRINT: update'  }
          );
