...
module.exports = function(sails) {	
	...
	function bindShadowRoutes () {
		...
		_.each(sails.controllers, function eachController (controller, controllerId) {
			...
			// Determine controller's actions and base route using global and controller-specific config.
			var actions = _.functions(sails.middleware.controllers[controllerId]);
