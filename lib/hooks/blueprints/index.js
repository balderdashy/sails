...
module.exports = function(sails) {
  ...
  return {
    ...
    bindShadowRoutes: function() {
      ...
      var defaultArchiveInUse = _.some(sails.models, function(model) { return model.archiveModelIdentity === 'archive'; });
      ...
      if ( config.actions ) {
        ...
        _.each(actions, function(action, key) {
          ...
          if (_.some(config._controllers, function(config, controllerIdentity) {
