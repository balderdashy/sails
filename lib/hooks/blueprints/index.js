...
module.exports = function(sails) {
  ...
  function loadMiddleware (cb) {
    ...
    var blueprintType = sails.config.blueprints.blueprintType;
    if (blueprintType !== 'ember') {
      blueprintType = 'default';
    }
    console.log(blueprintType);
    var BlueprintController = {
      create  : require('./' + blueprintType + '-actions/create')
    , find    : require('./' + blueprintType + '-actions/find')
    , findone : require('./' + blueprintType + '-actions/findOne')
    , update  : require('./' + blueprintType + '-actions/update')
    , destroy : require('./' + blueprintType + '-actions/destroy')
    , populate: require('./' + blueprintType + '-actions/populate')
    , add     : require('./' + blueprintType + '-actions/add')
    , remove  : require('./' + blueprintType + '-actions/remove')
  };
