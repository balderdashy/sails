...
module.exports = function updateOneRecord (req, res) {
  ...
  var queryOptions = parseRequest('update', req);
  ...
  var query = Model.findOne(queryOptions.criteria.where, queryOptions.populates);
  query.exec(function found(err, matchingRecord) {
    ...
    Model.update(queryOptions.criteria.where, queryOptions.valuesToSet).meta({fetch: true}).exec(function updated(err, records) {
      ...
      var Q = Model.findOne(queryOptions.criteria.where, queryOptions.populates);
