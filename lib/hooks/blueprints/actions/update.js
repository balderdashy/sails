...
module.exports = function updateOneRecord (req, res) {
  ...
  var query = Model.findOne(_.cloneDeep(queryOptions.criteria), _.cloneDeep(queryOptions.populates));
  query.exec(function found(err, matchingRecord) {
    ...
    Model.update(_.cloneDeep(queryOptions.criteria), queryOptions.valuesToSet).meta(queryOptions.meta).exec(function updated(err, records) {
      ...
      var Q = Model.findOne(_.cloneDeep(queryOptions.criteria), _.cloneDeep(queryOptions.populates));
