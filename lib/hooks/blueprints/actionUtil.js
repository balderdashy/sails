...
module.exports = {
  ...
  parseLimit: function (req) {
    var controller = req._sails.controllers[req.options.controller]
    var DEFAULT_LIMIT = (controller._config && controller._config.defaultLimit) || sails.config.blueprints.defaultLimit || 30;
