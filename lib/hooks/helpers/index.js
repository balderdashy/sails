...
module.exports = function(sails) {
  ...
  return {
    ...
    configure: function() {
      ...
      // If top-level sniffing tactic was set, apply it (unless overridden).
      if (sails.config.helpers.usageOpts.implementationSniffingTactic === undefined && sails.config.implementationSniffingTactic !== undefined) {
        sails.config.helpers.usageOpts.implementationSniffingTactic = sails.config.implementationSniffingTactic;
      }
