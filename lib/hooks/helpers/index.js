      ...
      if (sails.config.helpers.usageOpts.arginStyle !== 'named' || sails.config.helpers.usageOpts.execStyle !== 'deferred') {
        ...
        if (isMinSVRPointedAtSensitiveV1Prerelease) {
          ...
          sails.log.warn(
            ...
            '`.with()` every time you call a helper to continue using named parameters.  Then update the '+
            '`sails` dependency in your package.json file so that it satisfies ^1.0.0-44.\n'+
