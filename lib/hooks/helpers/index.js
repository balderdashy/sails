    ...
    configure: function() {
      ...
      if (sails.config.helpers.usageOpts.arginStyle !== 'named' || sails.config.helpers.usageOpts.execStyle !== 'deferred') {
        ...
        if (isMinSVRPointedAtSensitiveV1Prerelease) {
          ...
          '\n'+
          'But in the 1.0.0-44 prerelease, a change was introduced.  By default,\n'+
          'helpers now expect serial arguments instead of a dictionary of named\n'+
          'parameters.  In other words, you\'d now call:\n'+
          ...
          '\n'+
          ' (A) <<<<Quick & dirty>>>>\n'+
          ' If you need a quick fix, nestle this in your .sailsrc file:\n'+
          '     "helpers": {\n'+
          '       "usageOpts": {\n'+
          '         "arginStyle": "named",\n'+
          '         "execStyle": "deferred"\n'+
          '       }\n'+
          '     }\n'+
          ' (This will make everything work exactly the way it did before.)\n'+
          '\n'+
          ' (B) <<<<Recommended>>>>\n'+
          ' Change any relevant code in this app (e.g. `sails.helpers.…({…})`)\n'+
          ' so that it takes advantage of serial usage or .with().  Then update\n'+
          ' the `sails` dependency in your package.json file so that it\n'+
          ' satisfies ^1.0.0-44 or higher.\n'+
          '\n'+
          ' Note that, if you go with this solution, then you can still use\n'+
          ' .with() to call helpers with named parameters on a one-off basis.\n'+
          ' For example:\n'+
          '   await sails.helpers.changePassword.with({password:\'abc123\'});\n'+
          '\n'+
          '\n'+
          '(This warning will continue to display until this has been solved\n'+
          'one way or the other.  To hide this message, use one of the solutions\n'+
          'suggested above.)\n'+
          '\n'+
