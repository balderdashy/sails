          ...
          var treeDiagram = (function(){
            ...
            iterateHelpers(
              ...
              function _onHelper(callable, methodName, depth, isFirst, isLast, parent, grandparent){//eslint-disable-line no-unused-vars
                ...
                // } else
                if (isLast) {
                  treeDiagram += OFFSET + _.repeat(SYMBOL_NO_BRANCH, depth-1) + SYMBOL_LAST_BRANCH + (callable.toJSON()._fromLocalSailsApp ? chalk.bold.cyan(methodName) : chalk.italic(methodName)) + chalk.gray('()')+'\n';
                ...
                //   treeDiagram += OFFSET + TAB + SYMBOL_MID_BRANCH + methodName + '\n';
                  ...
                  treeDiagram += OFFSET + _.repeat(SYMBOL_NO_BRANCH, depth-1) + SYMBOL_MID_BRANCH + (callable.toJSON()._fromLocalSailsApp ? chalk.bold.cyan(methodName) : chalk.italic(methodName)) + chalk.gray('()')+'\n';
                }
