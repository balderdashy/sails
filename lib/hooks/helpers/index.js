        ...
        value: function inspect(){
          ...
          var treeDiagram = (function(){
            ...
            iterateHelpers(
              ...
              undefined,
              // function _onAfterFinishingPack(pack, key, depth, isFirst, isLast, lastnessPerAncestor){
              //   // if (isLast) {
              //   //   treeDiagram += '\nThat is it.\n';
              //   // }
              // },
              function _onHelper(callable, methodName, depth, isFirst, isLast, lastnessPerAncestor){
                ...
                // console.log('for helper `'+methodName+'`, lastnessPerAncestor is ',lastnessPerAncestor);
    ...
    furnishHelper: function(identityPlusMaybeSlug, nmDef){
      ...
      if (!_.get(sails.helpers, fullKeyPath)) {
        ...
        if (slug) {
          ...
          // console.log('=>',sails.config.helpers.usageOpts);
