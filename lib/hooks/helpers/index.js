      ...
      Object.defineProperty(sails.helpers, 'inspect', {
        ...
        value: function inspect(){
          ...
          var treeDiagram = (function(){
            ...
            iterateHelpers(
              sails.helpers,
              function _onBeforeStartingPack(pack, key, progressFraction){
                treeDiagram += key+':\n';
                // if (progressFraction === 1) {}
              },
              function _onAfterFinishingPack(pack, key, progressFraction){
              ...
              function _onHelper(callable, key, progressFraction){
                treeDiagram += '-- '+key+'()\n';
                if (progressFraction === 0) {
                  treeDiagram += '\n';
                } else if (progressFraction === 1) {
