    ...
    defaults: {
      helpers: {
        ...
        usageOpts: {
          ...
          // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
          // ^FUTURE: swap this in as a default (probably explicitly in the
          // generated boilerplate config rather than as an implicit default--
          // but not necessarily.  In the mean time, available as opt-in.)
          // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        },
