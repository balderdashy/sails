      ...
      Object.defineProperty(sails.helpers, 'inspect', {
        ...
        value: function inspect(){
          ...
          var treeDiagram = (function(){
            ...
            iterateHelpers(
              sails.helpers,
              function _onBeforeStartingPack(pack, key, isFirst, isLast){
                if (isFirst) {
                  treeDiagram += '-•-•-\n';
                }
                treeDiagram += key+':\n';
              },
              function _onAfterFinishingPack(pack, key, isFirst, isLast){
                if (isLast) {
                  treeDiagram += '\nThat is it.\n';
                }
              },
              function _onHelper(callable, key, isFirst, isLast){
                if (isFirst) {
                  treeDiagram += '|';
                }
