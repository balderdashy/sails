      ...
      Object.defineProperty(sails.helpers, 'inspect', {
        ...
        value: function inspect(){
          ...
          var treeDiagram = (function(){
            ...
            iterateHelpers(
              sails.helpers,
              function _onBeforeStartingPack(pack, key, keys, keyIdx){
                treeDiagram += key+':\n';
              },
              function _onAfterFinishingPack(pack, key, keys, keyIdx){
                if (keyIdx === 0) {
                  treeDiagram += '-•-•-';
                } else if (keyIdx === keys.length-1) {
                  treeDiagram += '\nThat is it.\n';
                } else {}
              },
              function _onHelper(callable, key, keys, keyIdx){
                if (keyIdx === 0) {
                  treeDiagram += '\n';
                  treeDiagram += '-- '+key+'()\n';
                } else if (keyIdx === keys.length-1) {
