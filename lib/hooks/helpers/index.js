...
module.exports = function(sails) {
  ...
  return {
    ...
    configure: function() {
      ...
      var isMinSVRPointedAtSensitiveV1Prerelease = false;//TODO
      // try {
      ...
      if (isMinSVRPointedAtSensitiveV1Prerelease && sails.config.helpers.usageOpts.arginStyle !== 'named' && sails.config.helpers.usageOpts.execStyle !== 'deferred') {
