  ...
  function getPubsubMethods () {
    ...
    return {
      ...
      subscribers: function (id, context) {
        ...
        sails.log.debug('`.subscribers()` uses `sails.sockets.subscribers()` which is now deprecated (see `http://next.sailsjs.org/documentation/concepts/upgrading/to-v-0-12`)');
