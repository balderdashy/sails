...
module.exports = function(sails) {
  ...
  function getPubsubMethods () {
    ...
    return {
      ...
      publish: function(records, data, req) {
        ...
        _.each(ids, function(id) {
          ...
          self.broadcast( room, self.identity, data, socketToOmit );
        });
      ...
      * @api public
      */
      subscribe: function (req, records) {
        ...
        _.each(ids,function (id) {
          ...
          if (sails.sockets.join( socket, self.room(id) )) {
            sails.log.silly(
              'Subscribed to the ' +
      ...
      unsubscribe: function (req, records) {
        ...
        _.each(ids,function (id) {
          ...
          if (sails.sockets.leave( socket, self.room(id))) {
            sails.log.silly(
