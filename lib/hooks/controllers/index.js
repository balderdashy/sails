	...
	return {
		...
		_interpretRouteSyntax: function (route) {
			...
			if (util.isString(target)) {
				...
				// Otherwise if the target cannot be parsed as dot notation, interpret this as a 302 redirect.
				// Requests will be redirected to the specified string (which hopefully is a URL!)
