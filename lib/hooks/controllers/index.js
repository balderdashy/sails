	...
	return {
		...
		initialize: function(cb) {
			...
			this.loadMiddleware(function (err) {
				...
				// Figure out whether this controller is capable of using the blueprint CRUD methods
				// (a model must exist with the same identity)
				var crudCapable = true;

				// Auto-routing for controller functions, `index`, and their other actions
				// As well as CRUD blueprints
