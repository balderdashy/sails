module.exports = function(sails) {
	...
	return {
		...
		bindActionRoutes: function () {
			...
			var finalBlueprints = sails.config.controllers.blueprints;
			...
			if ( sails.config.controllers.blueprints.actions ) {
				...
				_.each(sails.controllers, function (controller, controllerId) {
					...
					if (controller.blueprints){
						finalBlueprints = deepMerge(sails.config.controllers.blueprints, controller.blueprints);
					}
					// Apply prefix config 
					// TODO: strip leading and trailing slash
					var blueprintsPrefix = '/'+ finalBlueprints.prefix;
