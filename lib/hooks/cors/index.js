module.exports = function(sails) {
  ...
  return {
    ...
    initialize: function(cb) {
      ...
      if (sails.config.cors.allRoutes === true && sails.config.cors.origin === '*' && sails.config.cors.credentials === true && sails.config.cors.allowAnyOriginWithCredentialsUnsafe !== true) {
        ...
        _.each(sails.config.routes, function(config, route) {
          ...
          if (!_.isUndefined(config.cors)) {
            ...
            // Else if cors is an object, use that as the config
              ...
              if (routeCorsSettings.origin === '*' && routeCorsSettings.credentials === true) {
                if (routeCorsSettings.allowAnyOriginWithCredentialsUnsafe !== true) {
