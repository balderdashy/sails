module.exports = function(sails) {
  ...
  return {
    ...
    initialize: function(cb) {
      ...
      if (badRoutes.length) {
        sails.log.error('The following entries in `sails.config.csrf.disabledRoutes` were invalid:');
        sails.log.error('\n'+util.inspect(badRoutes));
        sails.log.error('Make sure you leave off the HTTP verb when specifying routes to disable CSRF on!\n');
      }
