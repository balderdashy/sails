...
module.exports = function (sails, app) {
	...
	return _.defaults(sails.config.express.middleware || {}, {
		...
		compress: (function () {
			if (IS_PRODUCTION) return express.compress();
		}),
		...
		bodyParser: (function () {
			...
			// Use default body parser, if `bodyParser` config is not defined
			if ( typeof sails.config.express.bodyParser === 'undefined') {
