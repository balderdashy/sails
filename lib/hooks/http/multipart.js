...
module.exports = function (sails) {
	...
	return function multipart (options) {
		...
		var multipartBodyParser;

		// For now, use it out of the box and deal with the warning.
		// (I'm working on a longer term solution, but this gets things working for now...)
		multipartBodyParser = express.multipart(options);
