    ...
    defaults: function(config) {
      return {
        ...
        http: {
          ...
          //Default options for the requestLogger
          //Enabled in dev environment and disabled in production
          //for other formats see: https://github.com/expressjs/morgan#predefined-formats
          requestLogger: {
            format: 'dev',
            inDevelopment: true,
            inProduction: false
