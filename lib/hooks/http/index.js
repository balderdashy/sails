    ...
    defaults: function(config) {
      return {
        ...
        http: {
          ...
          // > (However, the boilerplate config/http.js file and config/env/production.js
          // > in new Sails apps is different.)
          ...
          // (TODO: add deprecation message if this is attempted-- instead recommend using an arbitrary middleware)
