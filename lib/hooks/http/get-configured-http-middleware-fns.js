...
module.exports = function getBuiltInHttpMiddleware (expressRouterMiddleware, sails) {
  ...
  return _.defaults(sails.config.http.middleware || {}, {
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // TODO: this comment is now inaccurate
    // (instead, move this logic into the appropriate place where it is actually being attached)
    /**
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // TODO: this comment is now inaccurate
    // (instead, just move this logic into the appropriate place where it is actually being attached)
    //
    ...
    //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // TODO: this comment is inaccurate
    // (instead, just move this logic into the appropriate place where it is actually being attached)
