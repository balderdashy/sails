  ...
  return function initialize(cb) {
    ...
    (function _waitForSessionHookIfApplicable(next){
      ...
      try {
        ...
        sails.config.http.middleware.order.forEach((middlewareKey) => {
        ...
        preRouterMiddleware.forEach(middlewareKey => {
        ...
        sails.once('ready', function addPostRouterMiddleware() {
          ...
          postRouterMiddleware.forEach((middlewareKey) => {
