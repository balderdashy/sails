...
module.exports = function(sails) {
  ...
  return function initialize(cb) {
    ...
    (function _waitForSessionHookIfApplicable(next){
      ...
      var sailsRouter = express.Router();
      ...
      sails.on('router:bind', function(route) {
        ...
        sailsRouter[route.verb || 'all'](route.path || '/*', route.target);
      });
      ...
      sails.on('router:unbind', function(routeToRemove) {
        ...
        _.remove(sailsRouter.stack, function(layer) {
      ...
      _.each(_.remove(sails.config.http.middleware.order, function(middleware) { return _.contains(['startRequestTimer', '404', '500'], middleware); }), function (dupe) {
