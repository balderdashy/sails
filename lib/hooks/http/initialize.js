  ...
  return function initialize(cb) {
    ...
    (function _waitForSessionHookIfApplicable(next){
      ...
      sails.on('router:unbind', function(routeToRemove) {
        ...
        _.remove(expressApp.stack, function(layer) {
      ...
      sails.once('ready', function addPostRouterMiddleware() {
        ...
        // Add the www (static assets) middleware.
        expressApp.use(configuredHttpMiddlewareFns.www);

        // Add the favicon middleware.
        expressApp.use(configuredHttpMiddlewareFns.favicon);

        // Add the 404 middleware.
        expressApp.use(function handleUnmatchedRequest(req, res, next) {
