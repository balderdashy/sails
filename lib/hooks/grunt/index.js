module.exports = function (sails) {
  ...
  return {
    ...
    initialize: function (cb) {
      ...
      var pathToTasks = path.resolve(__dirname, '../../../../../tasks/register');
      // Start task depending on environment
      if(sails.config.environment === 'production'){
        return this.runTask('prod', cb);
      }
      else if(fs.existsSync(pathToTasks+"/"+sails.config.environment+".js")){
        return this.runTask(sails.config.environment, cb);
      }
