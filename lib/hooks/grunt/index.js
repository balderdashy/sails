module.exports = function (sails) {
	...
	var FatalError = require('../../errors/fatal'),
	...
	return {
		...
		initialize: function (cb) {
			...
			if(sails.config.environment === 'production'){
				return loadGrunt('prod', cb);
			}

			console.log('--->','loading dev gruntfile');
			loadGrunt('default', function (err) {
				console.log('GRUNT HOOK FIRED CB', err);
				cb();
			});
		}
	};
	 ...
	 * @api private
	 */
	function loadGrunt (taskName, cb) {
		...
		console.log('************ >> path to sails :: ', pathToSails);
