...
exports.defaults = function (userConfig) {
	...
	return {
		...
		// Paths for application modules
		paths: {
			views			: userConfig.appPath + '/views',
			controllers		: userConfig.appPath + '/controllers',
			models			: userConfig.appPath + '/models',
			servicesPath	: userConfig.appPath + '/services',
			middlewarePath	: userConfig.appPath + '/middleware'
		},
