module.exports = function(sails) {
	...
	function Router(options) {
		...
		Router.prototype.route = function(req, res, cb) {
			...
			reasonableDefaultRequest(req);
			reasonableDefaultResponse(res);

			// Use our slave router to route the request
			expressApp.router(req, res, this.wildcard);
		...
		Router.prototype.wildcard = function handleUnmatchedNext(status) {
