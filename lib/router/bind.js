module.exports = function (sails) {
	...
	/**
	 * Support "controller.action"  and "pathto/view" usage
	 * If no match is found, redirect requester using the specified target string 
	 * as the URL
	 *
	 * @api private
	 */
	...
	function _bind ( path, fn, verb ) {
		...
		var enhancedFn = function (req,res,next) {
			...
			// that should be run before each route middleware (NOT request)
