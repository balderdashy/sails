	...
	return {
		...
		500: function (err, req, res) {
			try {
				...
				if ( typeof (sails.errors && sails.errors.serverError) === 'function' ) {
					return sails.errors.serverError(err, req, res);
				}
		...
		404: function (req, res) {
			try {
				...
				if ( typeof (sails.errors && sails.errors.notFound) === 'function' ) {
					return sails.errors.notFound(req, res);
				}
