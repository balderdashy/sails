...
/**
 * Build mock request (i.e. `req`) object.
 * 
 * Used by hooks (i.e. sockets) but also for tests 
 * in userspace, and the core router unit tests.
 * 
...
module.exports = (function mock_req (){
	...
	// Mixin Sails core methods and properties.
	req.transport = 'mock';
