 ...
 */
exports.load = function loadSails(configOverride, cb) {
	...
	userConfig = _.extend(userConfig,modules.aggregate({
...
exports.initialize = function initSails(cb) {
	...
	sails.policies = _.extend({ "*" : true },sails.config.policies);
