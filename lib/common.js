...
exports.load = function loadSails(userConfig, cb) {
	...
	sails.adapters = require('./buildDictionary.js')(sails.config.appPath + '/adapters', /(.+Adapter)\.js$/, /Adapter/,true);
...
exports.initialize = function initSails(userConfig, cb) {
	...
	sails.services = require('./buildDictionary.js')(sails.config.appPath + '/services', /(.+)\.js$/, /Service/, true);
	sails.middleware = require('./buildDictionary.js')(sails.config.appPath + '/middleware', /(.+)\.js$/, null, true);
