...
function Collection (definition, adapter, cb) {
	...
	if (definition.attributes) {
		definition.attributes = sails.util.objMap(definition.attributes, function (attr, attrName) {
			var type;
	...
	this.filter = function(params) {
		...
		var trimmedParams = sails.util.objFilter(params, function(value, name) {
...
function enhanceLikeQuery(criteria, enhancer) {
	if (_.isObject(criteria)) {
		return sails.util.objMap(_.clone(criteria), enhancer);
	}
...
function buildModel (collection, cb) {
	return function (err, resultSet) {
		var mappedSet = sails.util.pluralize(resultSet, function (model) {
