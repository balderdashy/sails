...
var normalize = module.exports = {
	...
	resultSet: function (resultSet) {
		...
		return util.pluralize(resultSet, numberize);
	}
};


// If specified arg looks like a number, but it's a string
// cast it to a number
function numberize (arg) {
	if (_.isString(arg) && isNumbery(arg)) return +arg; 
	else return arg;
}
