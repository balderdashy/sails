...
Sails.prototype.build = function (taskName, cb) {
	...
	this.log.info('Building assets into directory...');
	this.spawnGrunt = require('../automation')(taskName, function (err) {
		if (err) return cb && cb(err);

		this.log.info('Successfully built \'www\' directory in the application root.');
		cb && cb();
	});
};
