...
module.exports = function getRouteFor(routeQuery){
  ...
  _.find(sails.router.explicitRoutes, function (routeTarget, key) {
  ...
  // Now that the raw route address been located, parse it into a method and a URL and build the route info
  // dictionary that will be returned from this function below.
  var routeInfo = {
    method: 'TODO',
    url: firstMatchingRouteAddress//TODO
  };
  // TODO
  //
  // e.g.
