...
module.exports = function(sails) {
  ...
  var Configuration = require('../configuration')(sails);
  var Router = require('../router')(sails);
  var initializeHooks = require('./loadHooks')(sails);
  ...
  return function load(configOverride, cb) {
    ...
    async.auto({
      ...
      // usage of the term.
      registry: ['hooks', function populateRegistry (cb) {
