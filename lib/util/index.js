...
/**
 * Returns a string in singluar format. Used for finding associated
 * controller when pluralization is enabled.
 */
exports.singularizeString = function singularizeString(str) {
