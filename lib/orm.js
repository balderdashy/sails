...
Model.extend = function (classObject) {
	...
	// parse options
	instance.options = {
		classMethods: _.extend(defaultClassMethods,_.clone(classObject.classMethods || {})),
		instanceMethods: _.extend(defaultInstanceMethods,_.clone(classObject.instanceMethods || {}))
	}
