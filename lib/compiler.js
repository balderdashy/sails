...
exports.compile=function(compilerCallback){
	...
	function decorateDependency(filename) {
		if (isDevelopment) {
			return "/_mast/lib/dependencies/"+filename+".min.js"
		}
		else {
			return "lib/mast/_mast/lib/dependencies/"+filename+".min.js"
		}
	}

	function decorateCoreFile(filename) {
		if (isDevelopment) {
			return "/_mast/lib/"+filename;
		}
		else {
			return "lib/mast/_mast/lib/"+filename;
		}
	}
