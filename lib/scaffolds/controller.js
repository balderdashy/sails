var scaffoldedController = function (modelName) {
	...
	return {
		...
		read: function (req,res) {
			...
			options.offset= req.param('skip') || req.param('offset') || undefined;
...
exports.definition = scaffoldedController;