...
var handleRequest = exports.handleRequest = function(target) {
		...
		return function(req, res, next) {
			...
			// Make asset inclusion partials accessible
			var viewPartials = _.objMap(assets,function(fn){return fn();});
			res.locals({
				rigging: viewPartials
			});
...
function enhanceRequest(req, res, controllerName, actionName) {
	...
	// _.shout(req.protocol,req.host,req.port, req.rootUrl);
