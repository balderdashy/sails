...
function guessAction(req) {
	...
	// If requestedAction is unknown in controller
	// AND unknown in blueprint (TODO: remove this part)
	// then treat requestedAction as id
	else if( controller[requestedAction] ) {
		console.log(requestedEntity, requestedAction, httpVerb, req.param('id'));
