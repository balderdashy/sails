...
var enhanceRequest = module.exports.enhance = function enhanceRequest(req, res, controllerName, actionName) {
	...
	res.view = function(specifiedPath, data, fun) {
		...
		// Stringify data
		var stringifiedData = sails.util.objMap(data, function(attr) {
...
function reroute(routePlan, req, res, next) {
	...
	// this is a array
		...
		doReroute(routePlan,req,res,function () { cb(); });
	}
