module.exports = function (sails) {
	...
	return function loadExpress (cb) {
		...
		app.engine(sails.config.views.engineExt, sails.config.views.engineFn);
		sails.express.app.set('view engine', sails.config.views.engineExt);
		...
		app.use(function (req, res, next) {
			...
			sails.config[404](null, req, res, next);
		});
