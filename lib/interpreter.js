// Load routes config
var urlMappings = _.extend({}, path.existsSync(sails.config.appPath + '/routes.js') ? require(sails.config.appPath + '/routes') : {});

var util = require('./util');
var router = require('./router');

// Get auth/access control library
// var policyMiddleware = require('./policy');
...
exports.route = function(socketReq, fn, socket) {
	...
	try {
		...
		return fn("Invalid socket request! The following JSON could not be parsed :: "+socketReq);
	}
