module.exports = function (sails) {
	...
	var util			= require('../util'),
		...
		Modules			= require('../hooks/moduleLoader');


	/**
	 * TODO: split hook-specific implicit defaults into their proper hooks
	 * TODO: split hook-specific validations into their proper hooks
	 * TODO: create `config` hook
	 *	(all it does is load config files from disk using the moduleLoader)
	 * TODO: move `consolidate` module into `views` hook.
	 *
	 */
