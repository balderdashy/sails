module.exports = function (sails) {
	...
	return function loadConfig (cb) {
		...
		async.auto({
			 ...
			 *
			 * TODO: use moduleloader to get this
			 */
			...
			/**
			 * TODO: completely remove this-- it all takes place in the `userconfig` hook now
			 */
			 ...
			 *
			 */
			mixinDefaults: ['loadAndBuild', function (cb, results) {
				...
				// Get overrides
				var userConfig = util.cloneDeep(results.mapOverrides);
			 ...
			 *
			 * TODO: move to hook so that it inherits userconfig
			 */
		...
		function configLoaded (err, results) {
			...
			var validatedConfig = results.mixinDefaults;
			// ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
			// TODO: do this in a cleaner way if possible
