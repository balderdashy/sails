	...
	function Configuration () {
		...
		this.defaults = function defaultConfig (appPath) {
			...
			return {
				...
				// TODO: add '*' option to set "the rest" during configuration
				// (you can't configure them in user config-- only overrides)
				hooks: {
				...
				// Start off `routes` and `middleware` as an object
				routes: {},
				middleware: {}
