module.exports = function (sails) {
	...
	return function validateConfiguration (config, originalUserConfig) {
		...
		if ( !config.views.engine.fn ) {
			var viewEngineModulePath = sails.config.appPath + '/node_modules/' + config.views.engine.ext, 
				fn;
			try {
				// 
				fn = consolidate(sails.config.appPath + '/node_modules')[config.views.engine.ext];
