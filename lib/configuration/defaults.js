module.exports = function (sails) {
    ...
    var userPaths = userConfig.paths || {}; // User shouldn't override, but just in case
		
		// Paths for application modules and key files
		var paths = {
			app				: userConfig.appPath,
			config			: userConfig.configPath || userConfig.appPath + '/config',
			tmp				: userConfig.tmpPath || userConfig.appPath + '/.tmp'
		};
