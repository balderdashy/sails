	...
	return function defaultConfig (userConfig) {
		...
		return {
			...
			hooks: {
				...
				connectSugar: require('../hooks/connectSugar'),
				// notFound: require('../hooks/notFound')(),
				// error: require('../hooks/error')(),
				csrf		: require('../hooks/csrf'),
				partials	: require('../hooks/partials'),
				express		: require('../hooks/express')
			},
			...
			controllers: {
				...
				// TODO: default 404 config

				// TODO: default misc. error code config
