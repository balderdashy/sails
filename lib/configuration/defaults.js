...
module.exports = function (userConfig) {
	...
	return {
		...
		// Default hooks
		hooks: {
			error: require('../hooks/error').signature(),
			views: require('../hooks/views').signature(),
			dynamicRoutes: require('../hooks/dynamicRoutes').signature(),
			csrf: require('../hooks/csrf').signature(),
			notFound: require('../hooks/notFound').signature()
		},
