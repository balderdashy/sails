...
> - [Mark Streleck](https://github.com/streleck)
...
- Create req.hostname (streleck ==> https://github.com/streleck)
- Update req.host.md and change to deprecated (streleck ==> https://github.com/streleck)
- Update req.isSocket.md (streleck ==> https://github.com/streleck)
- Update req.wantsJSON.md (streleck ==> https://github.com/streleck)
- Update req.hostname
- Fix docmeta tag
- Update req.isSocket.md
- Update req.wantsJSON.md
- Update res.send.md (streleck ==> https://github.com/streleck)
