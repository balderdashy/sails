...
Our short-to-medium-term roadmap items, in order of descending priority:
 ...
 :------------------------------------------------------- | :------------------------------------------------------------------------------- | :------
 Unbreak links in the documentation                       |                                                    | Fix existing links and inbound Google queries to the documentation so they once again route frustrated users to the correct page.
