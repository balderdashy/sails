...
Feature                                          | Summary
 ...
 Removing the Controller.js suffix convention   | User should be able to bypass convention of ending controller files with "Controller" ; Sails would consider any file in the api/controllers folder as a controller. A api/helpers folder could contains the files we need in controllers but that are not controller themselves.
