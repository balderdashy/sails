...
Add another starter template based on WebApp, (maybe disable emails and billing and use username + password?) | [#4423](https://github.com/balderdashy/sails/pull/4423) | Basically a more stripped down version of WebApp, so people who don't want to use email or billing don't have to tediously remove those features with various degree of knowledge.
