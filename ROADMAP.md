...
_(feel free to suggest things)_
 ...
 Improve CLI with hook support | [@kikobeats](https://github.com/Kikobeats) | When sails lift, print an informational message for know the hooks that are loaded in the system logging level is in `verbose` and `silly` .
