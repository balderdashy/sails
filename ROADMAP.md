...
_(feel free to suggest things)_
 ...
 i18n Routes Support | [@Zaggen](https://github.com/Zaggen) | Add support to use the i18n __() fn inside routes definitions to translate the route to multiple language without explicitly define it on the routes.js
