...
Public/Private model transformations | | It would be great to enable model properties to be included/exlcuded or transformed based on user access rights/authorization or other request dependent things. I.e. allow unauthorized access to /user/1, but respond only with the first letters of the name and remove all other identifying information.
