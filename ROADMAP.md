...
Have option to just populate relationship ids instead of whole values | [@BrighTide](https://github.com/BrighTide)| A lot of the time I find it far more effecient/effective to just talk about database entities as an id, rather than get the whole object. Not a huge problem for backend, but can make a massive speed difference for frontend stuff.
