...
var ResponsesView = TableView.extend({
	collectionClass: Responses,
	rowClass:ResponseView,
	emptyText: 'No user responses have been recorded yet.'
});

// Initialize
var responsesView;
responsesView = new ResponsesView();