...
var MessageTimelineView = RowView.extend({
	open: function () {
...
var MessageTimeline = Row.extend({});
var MessageTimelines = Rows.extend({
	model: MessageTimeline
});

var MessageTimelinesView = TableView.extend({
	// Parse message id from URL for filtering the fetch
	filter: function () {
		return this.message_id
	},
	
	emptyText: 'No one has interacted with this message.',
	collectionClass: MessageTimelines,
	rowClass:MessageTimelineView
});

// Initialize
var messageTimelinesView;
messageTimelinesView = new MessageTimelinesView();